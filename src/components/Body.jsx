        ...
        <div className=' w-screen mx-auto flex items-center justify-center border-x-4 border-black bg-red-300 h-[70%]'>
            <div className='md:w-3/4 w-[80%] h-[60%] md:h-[55%] flex items-center justify-center bg-slate-400'>
                <div className='text-center'>
                    ...
                    <button className="bg-slate-600 hover:bg-slate-800 text-base md:text-xl px-6 md:px-19 py-1 md:py-1.5 m-2 md:m-3 rounded font-semibold text-white"> Plus </button>
                    <button className="bg-slate-600 hover:bg-slate-800 text-base md:text-xl px-6 md:px-19 py-1 md:py-1.5 m-2 md:m-3 rounded font-semibold text-white"> Minus </button>
                </div>
            </div>
        </div>
    )
